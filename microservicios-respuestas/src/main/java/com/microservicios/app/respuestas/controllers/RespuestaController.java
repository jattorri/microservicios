...
public class RespuestaController {
    ...
    public ResponseEntity<?> obtenerExamenesIdsRespondidosAlumnos(@PathVariable Long alumnoId){
    	Iterable<Long> examenesIds = service.findExamenesIdsRespondidoByAlumno(alumnoId);
